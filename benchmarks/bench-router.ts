...
const routes: Route<any>[] = [
  ...
  { method: "GET", path: "/dashboard", data: [() => new Response("Dashboard")] },
  ...
  { method: "GET", path: "/api/posts/:slug", data: [() => new Response("Post")] },
  { method: "GET", path: "/api/products/:sku", data: [() => new Response("Product")] },
  { method: "GET", path: "/u/:username", data: [() => new Response("Profile")] },
  { method: "GET", path: "/c/:category", data: [() => new Response("Category")] },
  { method: "GET", path: "/download/:fileId", data: [() => new Response("Download")] },
  { method: "GET", path: "/docs/:page", data: [() => new Response("Docs")] },
  { method: "GET", path: "/events/:eventId", data: [() => new Response("Event")] },
  { method: "GET", path: "/orgs/:orgId", data: [() => new Response("Org")] },
  { method: "GET", path: "/settings/:section", data: [() => new Response("Settings")] },

  // 5 Deep/Multi Param routes
  { method: "GET", path: "/api/posts/:id/comments/:commentId", data: [() => new Response("Comment")] },
  { method: "GET", path: "/api/orgs/:orgId/teams/:teamId/members/:memberId", data: [() => new Response("Member")] },
  { method: "GET", path: "/repo/:owner/:repo/issues/:issueId", data: [() => new Response("Issue")] },
  { method: "GET", path: "/store/:country/:state/:city", data: [() => new Response("Store")] },
  { method: "GET", path: "/flights/:origin/:dest/:date", data: [() => new Response("Flight")] },

  // 5 Wildcard routes
  { method: "GET", path: "/public/*path", data: [() => new Response("Static")] },
  { method: "GET", path: "/assets/*path", data: [() => new Response("Assets")] },
  { method: "GET", path: "/images/*path", data: [() => new Response("Images")] },
  { method: "GET", path: "/api/legacy/*path", data: [() => new Response("Legacy")] },
...
console.log(`Running Realistic Mix Benchmark with ${iterations.toLocaleString()} iterations (${requestMix.length * iterations} total lookups)...\n`);
