 ...
 */
export function compileHandlerChain<E extends import("../types").Env = import("../types").Env>(handlers: Handler<Context<E>>[]): (context: Context<E>) => Promise<Response | undefined> {
