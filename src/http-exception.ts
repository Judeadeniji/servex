import type { ClientErrorStatusCode, ServerErrorStatusCode, StatusCode } from "./http-status";
...
export class HttpException extends Error {
  ...
  static paymentRequired(message?: string, data?: unknown, headers?: HeadersInit) {
  ...
  static methodNotAllowed(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 405, message, data, headers });
  }
  /** 406 Not Acceptable */
  static notAcceptable(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 406, message, data, headers });
  }
  /** 408 Request Timeout */
  static requestTimeout(message?: string, data?: unknown, headers?: HeadersInit) {
  ...
  static contentTooLarge(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 413, message, data, headers });
  }
  /** 415 Unsupported Media Type */
  static unsupportedMediaType(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 415, message, data, headers });
  }
  /** 422 Unprocessable Entity */
  static unprocessableEntity(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 422, message, data, headers });
  }
  /** 429 Too Many Requests */
  static tooManyRequests(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 429, message, data, headers });
  }
  /** 500 Internal Server Error */
  static internalServerError(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 500, message, data, headers });
  }
  /** 501 Not Implemented */
  static notImplemented(message?: string, data?: unknown, headers?: HeadersInit) {
  ...
  static serviceUnavailable(message?: string, data?: unknown, headers?: HeadersInit) {
    return new HttpException({ statusCode: 503, message, data, headers });
  }
  /** 504 Gateway Timeout */
  static gatewayTimeout(message?: string, data?: unknown, headers?: HeadersInit) {
